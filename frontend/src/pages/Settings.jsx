...
const Settings = () => {
  ...
  // useRef: Focus the name input on mount
  useEffect(() => {
    if (nameRef.current) {
      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 space-y-5">
          ...
          <div>
            ...
            <input type="password" className="w-full p-3 border rounded-xl dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-green-500 outline-none transition" placeholder="••••••••" />
          </div>
          <div>
